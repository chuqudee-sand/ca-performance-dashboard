    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6">
        {cohorts.map(c => {
          ...
          const topCountry = rows.sort((a, b) => b.Enrolled - a.Enrolled)[0]?.Country ?? "-";
          ...
          return (
            <Card key={c} title={`Cohort ${c}`}>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
                ...
                <div><p className="text-sm opacity-70">Top Country</p><p className="text-2xl font-bold">{topCountry}</p></div>
              </div>
            </Card>
          );
        })}
